...
**[Vector detects](#h_111212124131538839874145) \|\| [Talking to Vector ](#h_817152840231538839880732) \|\|  [Voice Commands](#h_817152840231538839880732) \|\| [Vector Q&A: Ask Vector a question](#h_503377977321538839886944) \|\| [Turning off voice detection](#h_630555305361538839895208)**
...
-   Give Vector a command e.g. “Come here!”![](//d33v4339jhl8k0.cloudfront.net/docs/assets/5e3f0b1e2c7d3a7e9ae777f5/images/5e7d764004286364bc975abe/img-25345-1585280575-1382936130.gif)
...
If you encounter any issues using Voice Commands, see [this FAQ](//support.digitaldreamlabs.com/article/99-vector-does-not-understand-me-troubleshooting-speech-recognition) for tips and troubleshooting
...
![](//d33v4339jhl8k0.cloudfront.net/docs/assets/5e3f0b1e2c7d3a7e9ae777f5/images/5e7d76402c7d3a7e9ae9e1ba/img-25345-1585280575-936313858.gif)

1.  Get Vector’s attention using one of the following two triggers:

2.  1.  “Hey Vector, I have a question”
    2.  “Hey Vector, look up a question for me”

3.  Vector will show he understood by displaying the above icon

4.  When he is ready to be asked, he will tell you, “Ready”

5.  Ask Vector a question – the more specific you are, the more likely he is to answer your question e.g. “What will the weather be like in London **on Saturday** **in degrees celsius**”

6.  If the question has multiple answers, he may give the answer that is first alphabetically

7.  If Vector didn’t detect or understand your question you will have to start again with “Hey Vector, I have  a question”

Take a look at Vector Q&A in “Things to Try” in the Vector companion app to learn more about it.

If you encounter any issues using Vector Q&A, see [this FAQ](//support.digitaldreamlabs.com/article/99-vector-does-not-understand-me-troubleshooting-speech-recognition) for tips and troubleshooting.
...
-   For more information on what Vector’s Back Lights mean, please see [this FAQ](//support.digitaldreamlabs.com/article/44-what-do-vectors-back-lights-mean)
-   For further information on Vector and privacy, please refer to [this FAQ](//support.digitaldreamlabs.com/article/105-vector-security-privacy-faqs)
