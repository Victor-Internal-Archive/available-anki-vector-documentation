...
**Note: Beginning in this release, new Escape Pod URL is ** [http://escapepod.local](http://escapepod.local)
...
-   If a page is refreshed or you try to refresh any page except “Licenses”, a 404 error will appear. To work around this, go back to [https://escapepod.local:8443/](https://escapepod.local:8443/)
