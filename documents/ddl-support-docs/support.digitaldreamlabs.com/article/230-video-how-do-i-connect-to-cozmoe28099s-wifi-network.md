...
**If you manage to connect to Cozmo successfully but Cozmo keeps disconnecting or turning off, please refer to [this FAQ](//support.digitaldreamlabs.com/article/203-int-cozmo-cozmo-connectivity).**

------------------------------------------------------------------------

# Sections

-   [**Information about Cozmo’s WiFi network**](#h_710854555651545312560486)
-   [**How do I set up Cozmo and connect to him?**](#h_2119327661061545312568119)
-   [**Cozmo won’t connect. What do I do?**](#h_479531951931546419314892)
-   [**Some specific issues and solutions**](#h_4202385891181546419320755)
    -   [**Applicable to iOS, Android and Fire**](#h_5375784781451546419327324)
    -   [**iOS-specific**](#h_4628563601581546419333605)
    -   [**Android-specific**](#h_6073485101711546419339284)
...
-   Install the Cozmo app on your **[compatible](//support.digitaldreamlabs.com/article/135-compatible-devices)** Amazon/Android/iOS device
...
-   Test with a **[compatible](//support.digitaldreamlabs.com/article/135-compatible-devices)** device
...
-   [**Powercycle Cozmo**](//support.digitaldreamlabs.com/article/220-how-to-powercycle-cozmo) and replace him on his charging platform
-   Restart your device
...
          ![](//d33v4339jhl8k0.cloudfront.net/docs/assets/5e3f0b1e2c7d3a7e9ae777f5/images/5e7d774e04286364bc975cac/img-3326-1585280660-369911531.png)
...
-   **Issue: I get a “Unable to join the network “Cozmo\_xxxxxx” message.** **Solution**: follow [**this troubleshooting**](#h_416067775481528818755456)
...
-   **Issue: I get a “Safety recommendation” message on my iOS device.** **Solution**: follow [**this troubleshooting**](#h_416067775481528818755456)
...
-   **Issue: I get an “authentication problem” on my Android device.** **Solution**: this message is a transitory issue with your device. Follow [this troubleshooting](#h_416067775481528818755456)
