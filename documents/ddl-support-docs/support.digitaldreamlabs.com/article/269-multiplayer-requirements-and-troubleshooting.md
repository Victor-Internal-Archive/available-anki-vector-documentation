...
**[Requirements for playing Multiplayer games](#h_604699657301532074394430) \|\|  [Errors you may see](#h_858546950561532074400701) \|\|  **

**[Basic troubleshooting](#h_73578868861532074408461) \|\|  **[Android-specific troubleshooting](#h_8930325511121532074414870)

------------------------------------------------------------------------

## Requirements for playing Multiplayer games

-   Each player should use a [compatible device](//support.digitaldreamlabs.com/article/255-compatible-devices-anki-overdrive-fast-furious-edition)
    -   The most recently released / powerful device should be the HOST
    -   Players using a device not on our [compatible list](//support.digitaldreamlabs.com/article/255-compatible-devices-anki-overdrive-fast-furious-edition) and/or have downloaded the app manually via our [APK](//support.digitaldreamlabs.com/article/244-download-the-android-apk) will have a better gaming experience when JOINING a Multiplayer game rather than HOSTING one
...
-   Before setting up a game, [all vehicles should be fully charged](//support.digitaldreamlabs.com/article/267-charging-vehicles-and-battery-life) (LED on roof should be a steady green and pulse green when removed from charging platform). Low vehicle battery can prevent setting up a Multiplayer game as well as cause in-game disconnects
...
-   [Activate location services](//support.digitaldreamlabs.com/article/274-enabling-location-services) on devices using Android 6 or higher
