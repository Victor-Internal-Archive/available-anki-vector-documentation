...
Studies such as through reputable sources like [Carnegie Mellon University](https://www.cmu.edu/) have been taken to gauge the impact of the educational value provided from our titles to students around the world, and here are three highlights:
...
![](https://lh3.googleusercontent.com/9IlUSeNVmNQQ_lfC5BtExB0CIm53vt8QoH-vmcpK386JcKOiVB7JKnO5hkKSW1PB-ItzzldpHXPlKOLXWx9EHWKEMZBWhqRCICyY8Jr0K_-VhTJdbKDIhqoz2wX-puQyCVxsDbj1)
...
With Puzzlets you can play Cork the Volcano, Abacus Finch, and Swatch Out! Find out about the [package for all three games here](https://www.digitaldreamlabs.com/pages/puzzlet-games-that-teach).

Each game is also available digitally (without Puzzlets) through [Steam](https://store.steampowered.com/search/?developer=Digital%20Dream%20Labs) and game copies can be redeemed [through our website](https://www.digitaldreamlabs.com/pages/smart-play) as well.
...
-   [Game Information ](/category/336-game-information)
-   [Technical Assistance ](/category/335-technical-assistance)
