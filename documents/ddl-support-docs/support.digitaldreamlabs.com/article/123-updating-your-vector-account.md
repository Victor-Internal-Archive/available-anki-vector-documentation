...
**[Creating an account](#h_957194025341545130817645) \|\|  [Logging into the Vector app](#h_319380833631545130823053) \|\|  [Updating account details](#h_456077077831545130830084) \|\|  [Resetting your password](#h_2020737221091545130837124) \|\|  [Deleting your account](#h_4267662571261545130842852) \|\|  [Linking Vector to a different account](#h_1572436011421545130850620)**
...
2.  To update your email address, please email us: support@digitaldreamlabs.com.[](https://www.digitaldreamlabs.com/pages/contact-us)
...
-   You may log in to multiple devices using the same account but you can only connect to Vector if the app on 1 device is foregrounded. See **[this FAQ](//support.digitaldreamlabs.com/article/118-can-i-use-multiple-vectors-or-devices)** for more info
-   If you want to create a new account for Vector, you will firstly need to [Erase User Data](//support.digitaldreamlabs.com/article/112-how-to-reset-erase-and-restore-vector) on Vector
