...
1.  License your Vector:
    ...
    4.  Open a new tab in your browser and connect to [http://escapepod.local](http://escapepod.local)
...
3.  Replace existing server\_config.json contents:  
    ...
    5.  Edit server\_config.json to point to Escape Pod: *$ nano /anki/data/assets/cozmo\_resources/config/server\_config.json  
...
5.  Roll through Vector-Web-Setup to finalize onboarding  
    1.  Connect to [http://escapepod.local](http://escapepod.local) and click on “Onboarding” in the top right corner.
