...
If you would like to know more about minimum requirements for charging Vector, how long Vector’s battery lasts, and some tips on where the charger should be placed, please see [this article](//support.digitaldreamlabs.com/article/117-how-to-charge-vector).
...
-   [**Vector is unable to find his charger**](#h_951963080271539008078624)
-   [**Check Vector's battery**](#h_915712754331539008083384)
-   [**Using the Customer Care Info Screen (CCIS)**](#h_252426581211539007775438)
...
6.  If he does not do this, check his battery in the Customer Care Info Screen. [**See steps below**](#h_252426581211539007775438)
...
9.  If you continue to encounter issues, it is possible that the battery inside the Vector is exhausted and needs to be replaced. Please contact Digital Dream Labs to open a support ticket: support@digitaldreamlabs.com
