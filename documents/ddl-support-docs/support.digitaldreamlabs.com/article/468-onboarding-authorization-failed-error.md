...
Please ensure that you have covered the steps above in the Standard Robots section before moving into this section. **Be aware that if your Vector has not been unlocked with a custom OSKR image and flashed with new firmware, then this section* *will not apply to you.**
