...
To properly dispose of any product once it reaches its end of life, check your local authority for recycling advice and facilities.
...
**[United States](https://www.epa.gov/smm-electronics/regulations-initiatives-and-research-electronics-stewardship)**

\[US Environmental Protection Agency (EPA) www.epa.gov\]

State Electronics Laws

"Twenty-five states currently have electronics recycling laws. The National Center for Electronics Recycling (NCER) developed [an interactive map](http://www.ecycleclearinghouse.org/content.aspx?pageid=10) \[www.ecycleclearinghouse.org - Requires Adobe Flash\] that helps to find out detailed information on state regulations, including a brief summary and link to the laws as well as key dates. Visit NCERs website to find out more about [state electronics laws](http://www.electronicsrecycling.org/?page_id=37) \[www.ecycleclearinghouse.org\]."
